...
<main>
  <div>
    ...
    <div>
      <h2 style="margin-left: 200px; margin-top: 100px;"> Ujian Tengah Semester - <?= $ambilmapel['mapel']; ?></h2>
    </div>
  </div>
    ...
    <div class="card p-4">
      <form id="soalForm" action="" method="post">
        <div id="soalContainer" class="container mt-4">
          ...
          $getdata = mysqli_query($mysqli, "SELECT * FROM ujian, mapel, soal WHERE ujian.id_mapel=mapel.id_mapel AND mapel.id_mapel='$getmapel' AND ujian.jenis_ujian='Ujian Tengah Semester' AND soal.id_ujian=ujian.id_ujian;");
          ...
          $ambilujian = mysqli_query($mysqli, "SELECT * FROM ujian where id_mapel='$pilihmapel' and jenis_ujian='Ujian Tengah Semester';");
