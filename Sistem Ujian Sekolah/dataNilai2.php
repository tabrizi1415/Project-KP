...
<main>
	<div>
		...
		<div>
			...
			$getmapel = mysqli_query($mysqli, "SELECT * FROM mapel, guru where mapel.id_guru=guru.nip and guru='$getUserLogin';");
			$ambilmapel = mysqli_fetch_array($getmapel);
			?>
			<h1 style="margin-left: 200px; margin-top: 100px;">Data Nilai - <?= $ambilmapel['mapel']; ?></h1>
		</div>
	</div>
	<div class="content-produk">
		...
		<table class="table-produk">
			...
			<?php
			$ambildata = mysqli_query($mysqli, "SELECT * FROM siswa, kelas, nilai where siswa.id_kelas=kelas.id_kelas and nilai.id_siswa=siswa.nis group by siswa order by siswa asc;");
			$i = 1;
