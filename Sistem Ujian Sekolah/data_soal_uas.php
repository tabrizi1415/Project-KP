...
<main>
	<div>
		...
		<div>
			<h2 style="margin-left: 200px; margin-top: 100px;">Data Soal - Ujian Akhir Semester - <?= $ambilmapel['mapel']; ?></h2>
		</div>
	</div>
	<div class="container mt-5">
		<div class="content-produk">
			<a href="buat_soal_uas.php" class="btn btn-tambahkan-produk">
			...
			$soalQuery = mysqli_query($mysqli, "SELECT * FROM soal WHERE id_ujian IN (
                SELECT id_ujian FROM ujian WHERE id_mapel='$getmapel' and jenis_ujian='Ujian Akhir Semester'
            );");
			?>
